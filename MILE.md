...
MILE is a multi-level framework for scalable graph embedding. It supports the majority of existing graph embedding techniques.
...
* format: the format of a dataset, should be either *edgelist* or *metis*, e.g., `--format metis`.
...
Follow the steps below to add a new base embedding method:
  ...
  2. Add the choice of the new method name to `--basic-embed` in the arguments of `./main.py` (*line-32*).
